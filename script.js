function myFunction() {
    ...
    const url='https://landslideprediction-c2241-default-rtdb.asia-southeast1.firebasedatabase.app/Moisture Sensor.json';
...
function myFunction2() {
    ...
    //console.log(selectedDate);
    const Http = new XMLHttpRequest();
    const url='https://landslideprediction-c2241-default-rtdb.asia-southeast1.firebasedatabase.app/Vibration Sensor.json';
